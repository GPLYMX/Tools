...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="labelme2yoloseg")
    parser.add_argument("--input_folder", default=r'D:\mycodes\RITH\puer\data_20231020\train\yolo_impurity\labels', help="输入LabelMe格式文件的文件夹")
    parser.add_argument("--output_folder", default=r'D:\mycodes\RITH\puer\data_20231020\train\yolo_impurity\labels', help="输出YOLO格式文件的文件夹")
    parser.add_argument("--split_rate", default=0.7, help="调整训练集和测试集的比重")
