...
if __name__ == '__main__':
    ...
    先使用change_and_save_json_label.py文件预处理json文件
    """
    parser = argparse.ArgumentParser()
    parser.add_argument('--json_dir', type=str, default=r'D:\mycodes\RITH\puer\data_20231020\data\yolo_impurity\labels',
